...
# is in the manual.
COMMENT_SYSTEM_ID = "blog-odooist-com"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-153616088-1"></script>
<script>
...
TWITTER_CARD = {
    ...
    'site': '@odooist',         # twitter nick for the website
    'creator': '@odooist',     # Username for the content creator / author.
}
